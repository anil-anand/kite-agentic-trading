...
def test_simulated_broker():
    ...
    # Place a buy order
    broker.place_market_order("TEST", "BUY", 10, 100.0, now, signal_info={"stopLoss": 90, "target": 120})
...
def test_metrics_evaluator():
    trades = [
        {"entry_time": "2023-01-01 10:00:00", "exit_time": "2023-01-01 10:30:00", "gross_pnl": 500, "net_pnl": 450, "total_fees": 50, "quantity": 10, "entry_price": 100},
        {"entry_time": "2023-01-02 10:00:00", "exit_time": "2023-01-02 10:30:00", "gross_pnl": -200, "net_pnl": -250, "total_fees": 50, "quantity": 10, "entry_price": 100},
    ]
