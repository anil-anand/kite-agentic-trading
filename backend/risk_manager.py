...
class RiskManager:
    ...
    def can_trade(self) -> Tuple[bool, str]:
        ...
        no_new_trades_after = datetime.datetime.strptime(config["noNewTradesAfter"], "%H:%M").time()
        ...
        if self.open_positions >= config["maxSimultaneousPositions"]:
            return False, f"Max simultaneous positions ({config['maxSimultaneousPositions']}) reached"
