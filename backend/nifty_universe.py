...
NIFTY_50 = [
    "ADANIPORTS", "ITC", "BHARTIARTL", "BAJAJ-AUTO", "HCLTECH",
    "RELIANCE", "ADANIENT", "DRREDDY", "TMPV", "HINDUNILVR",
    "ONGC", "INFY", "HINDALCO", "JSWSTEEL", "KOTAKBANK",
    "EICHERMOT", "M&M", "ULTRACEMCO", "COALINDIA", "SBILIFE",
    "TECHM", "CIPLA", "HDFCBANK", "TRENT", "HDFCLIFE",
    "NTPC", "TATACONSUM", "BAJFINANCE", "POWERGRID", "ETERNAL",
    "BEL", "TATASTEEL", "LT", "ICICIBANK", "TITAN",
    "APOLLOHOSP", "MARUTI", "JIOFIN", "SBIN", "GRASIM",
    "WIPRO", "TCS", "SUNPHARMA", "AXISBANK", "BAJAJFINSV",
    "ASIANPAINT", "MAXHEALTH", "NESTLEIND", "INDIGO", "SHRIRAMFIN"
]
