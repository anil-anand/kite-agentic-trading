...
class TradingCostCalculator:
    ...
    def calculate_leg_charges(self, price: float, quantity: int, side: str) -> Dict[str, float]:
        ...
        return {
            ...
            "gst": gst_rnd,
            "stamp": stamp,
            "total": round(brokerage_rnd + stt + exchange_txn_rnd + sebi_rnd + gst_rnd + stamp, 2)
        }
