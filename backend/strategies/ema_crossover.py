...
class EMACrossoverStrategy(BaseStrategy):
    ...
    def calculate_signals(self, df: pd.DataFrame, tradingsymbol: str) -> List[Dict[str, Any]]:
        ...
        # BUY Condition
        if prev['fast_ema'] <= prev['slow_ema'] and last['fast_ema'] > last['slow_ema'] and vol_confirmed:
            entry = last['close']
        ...
        # SELL Condition
        elif prev['fast_ema'] >= prev['slow_ema'] and last['fast_ema'] < last['slow_ema'] and vol_confirmed:
            entry = last['close']
