...
class MFIExhaustionStrategy(BaseStrategy):
    def get_name(self) -> str:
        return "MFI Exhaustion"

    def get_description(self) -> str:
        return "Volume-weighted RSI trading exhaustion zones (<20 or >80)."
        ...
        if prev["mfi"] < 20 and last["mfi"] >= 20:
            ...
            signals.append(
                self.format_signal(
                    ...
                    "MFI volume exhaustion bounce from 20",
                    {},
                )
            )
            ...
            signals.append(
                self.format_signal(
                    ...
                    "MFI volume exhaustion rejection from 80",
                    {},
                )
            )
        return signals
